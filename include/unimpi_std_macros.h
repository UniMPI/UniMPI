...
#define MPI_Comm_create_keyval unimpi.comm_create_keyval
#define MPI_Comm_free_keyval unimpi.comm_free_keyval
#define MPI_Comm_set_attr unimpi.comm_set_attr
#define MPI_Comm_get_attr unimpi.comm_get_attr
#define MPI_Comm_delete_attr unimpi.comm_delete_attr
#define MPI_Type_create_keyval unimpi.type_create_keyval
#define MPI_Type_free_keyval unimpi.type_free_keyval
#define MPI_Type_set_attr unimpi.type_set_attr
#define MPI_Type_get_attr unimpi.type_get_attr
#define MPI_Type_delete_attr unimpi.type_delete_attr
#define MPI_Keyval_create unimpi.keyval_create
#define MPI_Keyval_free unimpi.keyval_free
#define MPI_Register_datarep unimpi.register_datarep
