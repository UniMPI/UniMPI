...
/* UNIMPI_MPI_AT_LEAST truth table, relative to the compiled-in target
...
#error "target must satisfy UNIMPI_MPI_AT_LEAST(target)"
#endif
#if !UNIMPI_MPI_AT_LEAST(UNIMPI_MPI_TARGET_VERSION, 0)
#error "target must satisfy UNIMPI_MPI_AT_LEAST(target, 0)"
#endif
#if !UNIMPI_MPI_AT_LEAST(UNIMPI_MPI_TARGET_VERSION - 1, 0)
#error "target must satisfy UNIMPI_MPI_AT_LEAST(target - 1, 0)"
#endif
#if UNIMPI_MPI_AT_LEAST(UNIMPI_MPI_TARGET_VERSION + 1, 0)
#error "target must NOT satisfy UNIMPI_MPI_AT_LEAST(target + 1, 0)"
#endif
#if UNIMPI_MPI_AT_LEAST(UNIMPI_MPI_TARGET_VERSION, UNIMPI_MPI_TARGET_SUBVERSION + 1)
#error "target must NOT satisfy UNIMPI_MPI_AT_LEAST(target, subversion + 1)"
#endif
