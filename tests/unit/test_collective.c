...
void test_bcast(void) {
    ...
    TEST_CHECK_SUCCESS(unimpi.bcast(&buf, 1, MPI_INT, 0, MPI_COMM_WORLD));
...
void test_reduce(void) {
    ...
    /* Sum reduction */
    TEST_CHECK_SUCCESS(unimpi.reduce(&send_val, &recv_val, 1, MPI_INT, MPI_SUM,
                                     0, MPI_COMM_WORLD));
...
void test_allreduce(void) {
    ...
    /* Allreduce with sum */
    TEST_CHECK_SUCCESS(unimpi.allreduce(&send_val, &recv_val, 1, MPI_INT,
...
void test_gather(void) {
    ...
    /* Gather to rank 0 */
    TEST_CHECK_SUCCESS(unimpi.gather(&send_val, 1, MPI_INT, recv_buf, 1, MPI_INT,
                                     0, MPI_COMM_WORLD));
...
void test_scatter(void) {
    ...
    /* Scatter from rank 0 */
    TEST_CHECK_SUCCESS(unimpi.scatter(send_buf, 1, MPI_INT, &recv_val, 1, MPI_INT,
                                      0, MPI_COMM_WORLD));
