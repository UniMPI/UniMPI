...
int (*intelmpi_neighbor_alltoallv)(const void *, const int *, const MPI_Aint *,
    const int *, void *, const int *, const MPI_Aint *, const int *, MPI_Comm);
int (*intelmpi_neighbor_alltoallw)(const void *, const int *, const MPI_Aint *,
    const int *, void *, const int *, const MPI_Aint *, const int *, MPI_Comm);
int (*intelmpi_ineighbor_alltoallv)(const void *, const int *, const MPI_Aint *,
    const int *, void *, const int *, const MPI_Aint *, const int *, MPI_Comm,
    MPI_Request *);
int (*intelmpi_ineighbor_alltoallw)(const void *, const int *, const MPI_Aint *,
    const int *, void *, const int *, const MPI_Aint *, const int *, MPI_Comm,
    MPI_Request *);
...
int intelmpi_wrap_neighbor_alltoallw(const void *sendbuf, const int *sendcounts,
    ...
    int ret = intelmpi_neighbor_alltoallw(sendbuf, sendcounts, sdispls,
        (const int *)sendtypes, recvbuf, recvcounts, rdispls,
        (const int *)recvtypes, comm);
...
int intelmpi_wrap_neighbor_alltoallv(const void *sendbuf, const int *sendcounts,
    const MPI_Aint *sdispls, const MPI_Datatype *sendtypes, void *recvbuf,
    const int *recvcounts, const MPI_Aint *rdispls, const MPI_Datatype *recvtypes,
    MPI_Comm comm) {
    int indeg = 0, outdeg = 0;
    ...
    dtypes_compress_inplace(sendtypes, outdeg);
    dtypes_compress_inplace(recvtypes, indeg);
    int ret = intelmpi_neighbor_alltoallv(sendbuf, sendcounts, sdispls,
        (const int *)sendtypes, recvbuf, recvcounts, rdispls,
        (const int *)recvtypes, comm);
    dtypes_restore_inplace((MPI_Datatype *)sendtypes, outdeg);
    dtypes_restore_inplace((MPI_Datatype *)recvtypes, indeg);
...
int intelmpi_wrap_ineighbor_alltoallv(const void *sendbuf, const int *sendcounts,
    const MPI_Aint *sdispls, const MPI_Datatype *sendtypes, void *recvbuf,
    const int *recvcounts, const MPI_Aint *rdispls, const MPI_Datatype *recvtypes,
    MPI_Comm comm, MPI_Request *request) {
    int indeg = 0, outdeg = 0;
    ...
    dtypes_compress_inplace(sendtypes, outdeg);
    dtypes_compress_inplace(recvtypes, indeg);
    int ret = intelmpi_ineighbor_alltoallv(sendbuf, sendcounts, sdispls,
        (const int *)sendtypes, recvbuf, recvcounts, rdispls,
        (const int *)recvtypes, comm, request);
    dtypes_restore_inplace((MPI_Datatype *)sendtypes, outdeg);
    dtypes_restore_inplace((MPI_Datatype *)recvtypes, indeg);
...
int intelmpi_wrap_ineighbor_alltoallw(const void *sendbuf, const int *sendcounts,
    const MPI_Aint *sdispls, const MPI_Datatype *sendtypes, void *recvbuf,
    const int *recvcounts, const MPI_Aint *rdispls, const MPI_Datatype *recvtypes,
    MPI_Comm comm, MPI_Request *request) {
    int indeg = 0, outdeg = 0;
    ...
    dtypes_compress_inplace(sendtypes, outdeg);
    dtypes_compress_inplace(recvtypes, indeg);
    int ret = intelmpi_ineighbor_alltoallw(sendbuf, sendcounts, sdispls,
        (const int *)sendtypes, recvbuf, recvcounts, rdispls,
        (const int *)recvtypes, comm, request);
    dtypes_restore_inplace((MPI_Datatype *)sendtypes, outdeg);
    dtypes_restore_inplace((MPI_Datatype *)recvtypes, indeg);
