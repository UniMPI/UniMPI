 ...
 * Verified against MPICH 4.2.0 system headers:
...
static void init_mpich_error_codes(void) {
    ...
    MPI_ERR_DISP = 52;
    MPI_ERR_ASSERT = 53;
    /* MPI_ERR_PROC_FAILED and MPI_ERR_PROC_FAIL_STOP not defined in MPICH */
    /* MPICH uses MPI_ERR_PROC_ABORTED = 76 for process failure */
...
int unimpi_vtable_init_mpich(unimpi_lib_handle_t handle) {
    ...
    (mpich_waitall = (int (*)(int, int*, MPI_Status*))
        unimpi_platform_dlsym(handle, "MPI_Waitall"));
    unimpi.waitall = mpich_wrap_waitall;
    ...
    (mpich_testany = (int (*)(int, int*, int*, int*, MPI_Status*))
        unimpi_platform_dlsym(handle, "MPI_Testany"));
    unimpi.testany = mpich_wrap_testany;
    (mpich_testsome = (int (*)(int, int*, int*, int*, MPI_Status*))
        unimpi_platform_dlsym(handle, "MPI_Testsome"));
    unimpi.testsome = mpich_wrap_testsome;
    (mpich_testall = (int (*)(int, int*, int*, MPI_Status*))
        unimpi_platform_dlsym(handle, "MPI_Testall"));
    unimpi.testall = mpich_wrap_testall;
    (mpich_waitany = (int (*)(int, int*, int*, MPI_Status*))
        unimpi_platform_dlsym(handle, "MPI_Waitany"));
    unimpi.waitany = mpich_wrap_waitany;
    (mpich_waitsome = (int (*)(int, int*, int*, int*, MPI_Status*))
        unimpi_platform_dlsym(handle, "MPI_Waitsome"));
    unimpi.waitsome = mpich_wrap_waitsome;
    ...
    (mpich_startall = (int (*)(int, int*))
        unimpi_platform_dlsym(handle, "MPI_Startall"));
    unimpi.startall = mpich_wrap_startall;
    ...
    mpich_type_get_contents = (int (*)(MPI_Datatype, int, int, int,
            int*, MPI_Aint*, MPI_Datatype*))
            unimpi_platform_dlsym(handle, "MPI_Type_get_contents");
    if (mpich_type_get_contents) {
        unimpi.type_get_contents = mpich_wrap_type_get_contents;
    }
     ...
     * 4-byte handle representation) */
    mpich_ialltoallw = (int (*)(const void*, const int*,
            const int*, const int*, void*, const int*, const int*, const int*,
            MPI_Comm, MPI_Request*))
            unimpi_platform_dlsym(handle, "MPI_Ialltoallw");
    if (mpich_ialltoallw) {
        unimpi.ialltoallw = mpich_wrap_ialltoallw;
    }
    ...
    mpich_neighbor_alltoallv = (int (*)(const void*, const int*, const MPI_Aint*, const int*,
            void*, const int*, const MPI_Aint*, const int*, MPI_Comm))
            unimpi_platform_dlsym(handle, "MPI_Neighbor_alltoallv");
    if (mpich_neighbor_alltoallv)
        unimpi.neighbor_alltoallv = mpich_wrap_neighbor_alltoallv;
    mpich_neighbor_alltoallw = (int (*)(const void*, const int*, const MPI_Aint*, const int*,
            void*, const int*, const MPI_Aint*, const int*, MPI_Comm))
            unimpi_platform_dlsym(handle, "MPI_Neighbor_alltoallw");
    if (mpich_neighbor_alltoallw)
        unimpi.neighbor_alltoallw = mpich_wrap_neighbor_alltoallw;
    ...
    mpich_ineighbor_alltoallv = (int (*)(const void*, const int*, const MPI_Aint*, const int*,
            void*, const int*, const MPI_Aint*, const int*, MPI_Comm, MPI_Request*))
            unimpi_platform_dlsym(handle, "MPI_Ineighbor_alltoallv");
    if (mpich_ineighbor_alltoallv)
        unimpi.ineighbor_alltoallv = mpich_wrap_ineighbor_alltoallv;
    mpich_ineighbor_alltoallw = (int (*)(const void*, const int*, const MPI_Aint*, const int*,
            void*, const int*, const MPI_Aint*, const int*, MPI_Comm, MPI_Request*))
            unimpi_platform_dlsym(handle, "MPI_Ineighbor_alltoallw");
    if (mpich_ineighbor_alltoallw)
        unimpi.ineighbor_alltoallw = mpich_wrap_ineighbor_alltoallw;
#endif
    ...
    /* Comm_spawn_multiple (wrapped) */
    mpich_comm_spawn_multiple = (int (*)(int, char*[], char**[],
            const int[], const int[], int, MPI_Comm, MPI_Comm*, int[]))
            unimpi_platform_dlsym(handle, "MPI_Comm_spawn_multiple");
    if (mpich_comm_spawn_multiple) {
        unimpi.comm_spawn_multiple = mpich_wrap_comm_spawn_multiple;
    }
    ...
    mpich_type_create_struct = (int (*)(int, const int*, const MPI_Aint*,
            const int*, MPI_Datatype*))
            unimpi_platform_dlsym(handle, "MPI_Type_create_struct");
    if (mpich_type_create_struct) {
        unimpi.type_create_struct = mpich_wrap_type_create_struct;
    }
    mpich_type_struct = (int (*)(int, const int*, const MPI_Aint*,
            const int*, MPI_Datatype*))
            unimpi_platform_dlsym(handle, "MPI_Type_struct");
    if (mpich_type_struct) {
        unimpi.type_struct = mpich_wrap_type_struct;
    }
    ...
    /* Predefined attribute callback values. MPICH-family exposes a single
     * shared MPIR_Dup_fn (reused across comm/type/win and the MPI-1 generic);
     * the null copy/delete values are NULL, so the defaults stay 0. */
    ...
    /* MPICH-family in-place sentinel is (void*)-1 (see their mpi.h). */
    MPI_IN_PLACE = (void *)-1;
    ...
    /* Initialize topology type constants (MPICH: MPI_GRAPH=1, MPI_CART=2) */
    UNIMPI_GRAPH = 1;
    UNIMPI_CART = 2;
    UNIMPI_DIST_GRAPH = 3;
     ...
     * /usr/lib/x86_64-linux-gnu/mpich/include/mpi.h; MPICH omits INVALID_ENUM,
     * which stays 0). */
    MPI_T_ERR_MEMORY = 59;
    ...
    /* UNIMPI_T_* enums: MPICH-family values are shifted (arbitrary bases to
     * aid debugging), with an *_INVALID=0 sentinel. */
    ...
    /* MPICH has no SOURCE_* / *_INVALID / *_NULL (*_SESSION_NULL etc.)
     * constants defined in the standard manner; leave 0. */
#endif
