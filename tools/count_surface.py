...
def main():
    ...
    print("note: %d fields is the language-level total -- a 3.1+ build carries "
          "all of them, but it includes fields gated behind "
          "UNIMPI_MPI_AT_LEAST(3,0)/(3,1); a specific target build carries "
          "UNIMPI_VTABLE_COUNT instead (run test_vtable_layout for the exact "
          "value)." % fields)
