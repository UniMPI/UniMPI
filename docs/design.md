...
The current dispatch structure has 364 MPI function-pointer fields (at target
3.0; fewer under a lower gate), and the standard-name header has 361 direct
`MPI_*` aliases. These inventory counts do
