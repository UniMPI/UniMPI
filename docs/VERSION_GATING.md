...
the target version. A 2.2 build has a smaller struct (297 fields) than a 3.0
build (364 fields). If you compile the library at one target and a consumer at
...
- Target 3.0: `VTABLE_SIZE=2912`, `VTABLE_COUNT=364`
