...
the target version. A 2.2 build has a smaller struct (299 fields) than a 3.0
build (363 fields). If you compile the library at one target and a consumer at
...
- Target 3.0: `VTABLE_SIZE=2904`, `VTABLE_COUNT=363`
- Target 2.2: `VTABLE_SIZE=2392`, `VTABLE_COUNT=299`
